    ...
    return (
        <>
            <div className="mb-5">
                ...
                <p>
                    This will call a local API on port 3001 that would have been started if you run{" "}
                    <code>npm run dev</code>. An access token is sent as part of the request's `Authorization` header
                ...
                <Button color="primary" className="mt-5" onClick={callPublic}>
                    Call Public
                </Button>
            </div>
